...
if (isset($_POST['submit1']) && !empty($_POST['actor_id']))
{
	require_once "DbConnection.php";
	$gene_id = mysqli_real_escape_string($connection, htmlentities($_POST["actor_id"]));
...
if (isset($_POST['submit1']) && empty($_POST['actor_id']))
	...
	{
		$error_message = 'please enter actor id';
	}
...
if(!empty($connection))
{
		$query = "SELECT first_name, last_name FROM ACTOR where ACTOR.actor_id = " . '"' . $gene_id . ' ;"';
